#pragma checksum "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\Cycles\_CreateCycle_Products.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "377e24f415323d41920bc86697ed52ea3bc7da91"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"377e24f415323d41920bc86697ed52ea3bc7da91", @"/Views/Cycles/_CreateCycle_Products.cshtml")]
    ...
    <div class=""container-fluid"" id=""product-tab-container"">
        <div class=""row"">
            ...
            WriteLiteral(@"
                    ...
                    <div style=""display:none"" id=""divProductTypeSearch"" class=""flex-column align-items-start my-3"">
                        <h5>Product Type</h5>
        ...
        ");
            ...
            <div class=""col-12 col-sm-6 col-md-4 px-4"">
                <h3>Selected <small>(<span id=""selectedProductsCount"">0</span>)</small></h3>
...
<script>
    ...
    $(() => {
        ...
        $(document).on('keyup', '.txtQuantity', e => {
