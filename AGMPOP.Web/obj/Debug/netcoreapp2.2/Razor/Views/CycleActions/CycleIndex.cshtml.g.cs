#pragma checksum "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\CycleActions\CycleIndex.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "29232022c44d6c8d9da5084586d219a3d75a0a7a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"29232022c44d6c8d9da5084586d219a3d75a0a7a", @"/Views/CycleActions/CycleIndex.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "29232022c44d6c8d9da5084586d219a3d75a0a7a4253", async() => {
            }
            );
...
<script>
    ...
    async function GetCycleList() {
        ...
        //const APIurl = BaseAPIurl + userlat + ""/"" + userlng + ""/"" + DeviceId + ""/"" + userID + ""/cycles?Page="" + 1 + ""&Limit="" + 20;
         var divCycleList = $('#cycle");
            WriteLiteral("list\');\r\n        divCycleList.empty();\r\n\r\n\r\n\r\n        $.ajax({\r\n            url: \'");
            EndContext();
            BeginContext(1264, 22, false);
#line 48 "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\CycleActions\CycleIndex.cshtml"
             Write(Url.Action("GetCycle"));

#line default
#line hidden
            EndContext();
            BeginContext(1286, 416, true);
            WriteLiteral(@"',
            method: 'Get',
            success: (res) => {
                console.log(res);
...
#line 58 "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\CycleActions\CycleIndex.cshtml"
                                 Write(Url.Action("CycleTransaction"));

#line default
#line hidden
            EndContext();
            BeginContext(1733, 3029, true);
            WriteLiteral(@"?cycleId=${res.data[i].cycleId}"">
                            ...
                            <div class=""col-2 col-xl-1 d-flex flex-column justify-content-center text");
            WriteLiteral(@"-center"">
