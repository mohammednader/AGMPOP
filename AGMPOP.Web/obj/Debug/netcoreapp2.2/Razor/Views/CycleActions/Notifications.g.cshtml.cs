#pragma checksum "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\CycleActions\Notifications.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b15452f8495cba231cf705101e6f34e9c15e0fa7"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b15452f8495cba231cf705101e6f34e9c15e0fa7", @"/Views/CycleActions/Notifications.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "b15452f8495cba231cf705101e6f34e9c15e0fa74238", async() => {
            }
            );
                         ...
                         var NotificationsResponse = `${ss}
                            <div class=""card card-body mb-2 Home""  ${!res[i].isSeen ? `style=background-color:#f5f5dc;` : ``}>
                                <div class=""row"">
                                    ...
                                    <label>${moment(res[i].createdAt).format('DD/MM/YYYY')}</label> &nbsp
...
#line 92 "E:\TFS\POPAGM\AGMPOP_Core\AGMPOP.Web\Views\CycleActions\Notifications.cshtml"
             Write(Url.Action("SeenAt", "CycleActions"));

#line default
#line hidden
            EndContext();
            BeginContext(3396, 156, true);
            WriteLiteral("\',\r\n            type: \"Get\",\r\n            data: { notificationId },\r\n            success: response => {\r\n\r\n            },\r\n\r\n        });\r\n\r\n    }\r\n</script>");
            EndContext();
        }
